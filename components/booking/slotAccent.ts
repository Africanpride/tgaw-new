...
export const slotAccent: Record<string, SlotAccent> = {
  BIBLE: {
    ...
    booked:
      "bg-slate-100/90 border-slate-200/80 text-slate-500 dark:bg-slate-900/70 dark:border-slate-800 dark:text-slate-400",
    available:
      "bg-background hover:bg-purple-500/10 hover:border-purple-500/40 border-border text-foreground",
  },
  PRAYER: {
    text: "text-red-700 dark:text-red-300",
    iconText: "text-red-500",
    tabBorder: "border-red-500/30",
    ...
    booked:
      "bg-slate-100/90 border-slate-200/80 text-slate-500 dark:bg-slate-900/70 dark:border-slate-800 dark:text-slate-400",
    available:
      "bg-background hover:bg-red-500/10 hover:border-red-500/40 border-border text-foreground",
  },
  PRAISE_WORSHIP: {
    ...
    booked:
      "bg-slate-100/90 border-slate-200/80 text-slate-500 dark:bg-slate-900/70 dark:border-slate-800 dark:text-slate-400",
    available:
      "bg-background hover:bg-amber-500/10 hover:border-amber-500/40 border-border text-foreground",
  },
}
