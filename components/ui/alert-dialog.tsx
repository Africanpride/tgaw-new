...
function AlertDialogFooter({
	...
	return (
		<div
			...
			className={cn(
				"-mx-2 -mb-2 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-2 sm:-mx-4 sm:-mb-4 sm:flex-row sm:justify-end sm:p-4",
				className,
			)}
			{...props}
		/>
