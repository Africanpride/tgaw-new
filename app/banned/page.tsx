			...
			<Card className="w-full max-w-md overflow-hidden text-center shadow-lg">
				...
				<CardHeader className="pt-8">
					...
					<CardDescription className="mx-auto max-w-sm text-balance">
						Hi {user?.name?.split(" ")[0] ?? "there"}, your access to TGAW
						has been suspended.
					</CardDescription>
				</CardHeader>
				...
				<CardFooter className="flex flex-col gap-2 pb-8">
					<Button variant="outline" className="w-full gap-2" asChild>
						<a
							href={`mailto:support@tgaw.app?subject=${encodeURIComponent(
					...
					<p className="text-xs text-muted-foreground">
						<Link href="/" className="cursor-pointer text-primary hover:underline">
							Back to home
						</Link>
					</p>
				</CardFooter>
